        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Table Data Camat</h3>
                        ...
                        <tbody>
                          <?php foreach ($getCamat as $data) : ?>
                            <tr>
                              ...
                              <td><?= $data['alamat']; ?></td>
                              <td>
                                <img src="<?= base_url('/assets/assetGambar/administrator/') . $data['foto'] ?>" alt="administrator" width="30px">
                              </td>
                              <td>
